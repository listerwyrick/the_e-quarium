document.addEventListener("DOMContentLoaded", function () {
    ...
    const audioSources = [
        ...
        "https://github.com/tlq68/e-quarium/raw/main/assets/audio/Fish2.m4a",
        "https://github.com/tlq68/e-quarium/raw/main/assets/audio/Fish1.m4a"
    ];
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var isMuted = true; // Initialize a variable to track the mute state

    // Function to toggle the audio mute state and change the icon accordingly
    function toggleAudio() {
        if (isMuted) { // If currently muted, unmute the audio
        ...
        } else { // If muted, unmute the audio
